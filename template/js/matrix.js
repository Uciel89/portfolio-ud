...
function animate(timeStamp){
    ...
    // deltaTime -> es la diferencia en milisegundos entre el cuadro de animación anterior y la animación actual.
    ...
    if(timer > nextFrame){
        ...
        // Llamaos al método de dibujado y le pasamos el contexto
...
// Ajustado automáticamente el tamaño de la pantalla atravesé de canvas.width y canvas.height
